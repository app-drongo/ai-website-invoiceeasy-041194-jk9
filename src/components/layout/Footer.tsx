...
const DEFAULT_FOOTER = {
  logoText: 'InvoiceEasy',
  companyDescription:
    'Streamline your billing process with professional invoices, automated payments, and comprehensive financial reporting. Trusted by over 50,000 businesses worldwide.',
  contactEmail: 'support@invoiceeasy.com',
  contactPhone: '+1 (555) 847-3629',
  contactAddress: '456 Finance Plaza, Suite 200, Business District',
  newsletterTitle: 'Invoice Updates',
  newsletterPlaceholder: 'Enter your business email',
  newsletterDisclaimer:
    'Get billing tips, feature updates, and tax season reminders. Unsubscribe anytime.',
  section1Title: 'Features',
  section2Title: 'Company',
  section3Title: 'Support',
  section4Title: 'Legal',
  copyrightText: '© 2024 InvoiceEasy. All rights reserved.',
  madeWithText: 'by financial experts',
  socialText: 'Follow us:',
  social1Href: 'https://twitter.com/invoiceeasy',
  social2Href: 'https://facebook.com/invoiceeasy',
  social3Href: 'https://instagram.com/invoiceeasy',
  social4Href: 'https://linkedin.com/company/invoiceeasy',
  social5Href: 'https://github.com/invoiceeasy',
} as const;
...
export default function Footer(props: FooterProps) {
  ...
  const footerSections = [
      ...
      links: [
        {
          ...
          editableId: 'link-footer-invoice-generator',
        },
        { name: 'Payment Processing', href: '/payments', editableId: 'link-footer-payments' },
        { name: 'Expense Tracking', href: '/expenses', editableId: 'link-footer-expenses' },
        { name: 'Financial Reports', href: '/reports', editableId: 'link-footer-reports' },
        { name: 'Tax Management', href: '/tax-tools', editableId: 'link-footer-tax-tools' },
    ...
    },
    {
      ...
      links: [
        { name: 'About InvoiceEasy', href: '/about', editableId: 'link-footer-about' },
    ...
    },
    {
      ...
      links: [
        { name: 'Help Center', href: '/help', editableId: 'link-footer-help' },
        {
          ...
          editableId: 'link-footer-getting-started',
        },
        { name: 'Video Tutorials', href: '/tutorials', editableId: 'link-footer-tutorials' },
        { name: 'Billing Webinars', href: '/webinars', editableId: 'link-footer-webinars' },

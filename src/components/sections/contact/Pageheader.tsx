...
const DEFAULT_PAGEHEADER = {
  title: 'Get in Touch',
  description:
    'Ready to streamline your invoicing? Our team is here to help you get started with InvoiceEasy and answer any questions about our platform.',
  ctaText: 'Start Free Trial',
  ctaHref: '/',
  hasBackground: false, // Toggle for background color
  stat1Label: 'Response Time',
  stat1Value: '< 2 hrs',
  stat2Label: 'Setup Support',
  stat2Value: 'Free',
  stat3Label: 'Customer Rating',
  stat3Value: '4.9/5',
  stat4Label: 'Support Hours',
  stat4Value: '24/7',

...
const DEFAULT_CONTACT = {
  badge: 'Get Support',
  mainTitle: 'Need Help with',
  mainTitleHighlight: 'InvoiceEasy?',
  mainDescription:
    "Whether you're setting up your first invoice or need help with advanced features, our team is here to help you get paid faster.",
  formTitle: 'Send us a Message',
  formDescription:
    "Tell us about your invoicing needs and we'll get back to you within 2 hours during business hours.",
  submitButton: 'Send Message',
  contactSectionTitle: 'Get in Touch',
  method1Title: 'Email Support',
  method1Description: 'Get help with your account',
  method1Contact: 'support@invoiceeasy.com',
  method2Title: 'Sales Inquiries',
  method2Description: 'Questions about pricing',
  ...
  office1Address: '123 Startup Lane, Suite 200',
  office1Timezone: 'PST (UTC-8)',
  office2City: 'Austin',
  office2Address: '456 Business Blvd, Floor 5',
  office2Timezone: 'CST (UTC-6)',
  office3City: 'Remote Team',
  office3Address: 'Distributed worldwide',
  ...
  supportNote: 'Priority support for Business plan customers',
  nameLabel: 'Full Name *',
  namePlaceholder: 'Your full name',
  emailLabel: 'Email Address *',
  emailPlaceholder: 'your@email.com',
  companyLabel: 'Business Name (Optional)',
  companyPlaceholder: 'Your business or freelance name',
  messageLabel: 'How can we help? *',
  messagePlaceholder:
    'Tell us about your invoicing challenges, feature requests, or any questions you have...',
} as const;

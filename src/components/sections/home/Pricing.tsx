...
const DEFAULT_PRICING = {
  ...
  mainDescription:
    'Start free and scale as you grow. No hidden fees, no setup costs. Cancel anytime with full data export.',
  billingMonthly: 'Monthly',
  billingAnnual: 'Annual',
  billingAnnualBadge: 'Save 20%',
  plan1Name: 'Starter',
  plan1Description: 'Perfect for new freelancers just getting started',
  plan1Price: 'Free',
  plan1CTA: 'Start Free',
  plan1CTAHref: '/',
  plan2Name: 'Professional',
  plan2Description: 'For established freelancers managing multiple clients',
  plan2Price: '$19',
  plan2Period: '/month',
  ...
  plan3Name: 'Business',
  plan3Description: 'For agencies and growing businesses with teams',
  plan3Price: '$49',
  plan3Period: '/month',
  ...
  bottomDescription:
    'Managing a large team or have specific invoicing requirements? We offer custom enterprise solutions with dedicated support and advanced features.',

...
const DEFAULT_HERO = {
  ...
  title: 'Invoicing made simple for',
  titleHighlight: 'freelancers & small business',
  description:
    'Create professional invoices in seconds, track payments automatically, and manage your finances with ease. Built specifically for independent professionals.',
  features: [
  ...
  imageAlt: 'InvoiceEasy dashboard showing invoice creation',
  statsLabel1: 'Average Setup',
  statsValue1: 'Under 5 min',

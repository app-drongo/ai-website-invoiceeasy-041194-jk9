...
const DEFAULT_CTA = {
  badge: 'Join 50,000+ Freelancers',
  mainTitle: 'Ready to Get Paid',
  mainTitleHighlight: '30% Faster?',
  description:
    "Join thousands of freelancers and small business owners who've streamlined their invoicing with InvoiceEasy. Create professional invoices in 30 seconds and get paid faster than ever.",
  primaryCTA: 'Start Free Trial',
  primaryCTAHref: '/',
  secondaryCTA: 'Contact Sales',
  secondaryCTAHref: '/contact',
  trustText: 'Trusted by freelancers and small businesses worldwide',
  stat1Value: '50K+',
  stat1Label: 'Active Users',
  stat2Value: '30 sec',
  stat2Label: 'Invoice Creation',
  stat3Value: '30%',
  stat3Label: 'Faster Payments',
  stat4Value: '24/7',
  stat4Label: 'Support',
  feature1Title: '14-Day Free Trial',
  feature1Description: 'Full access, no credit card required',
  feature2Title: 'Bank-Level Security',
  feature2Description: 'Your financial data is protected with enterprise-grade encryption',
  feature3Title: '5-Minute Setup',
  feature3Description: 'Import clients and start invoicing immediately',
} as const;
...
export default function Cta(props: CTAProps) {
  ...
  const stats = [
    ...
    { value: config.stat3Value, label: config.stat3Label, icon: ArrowRight },
